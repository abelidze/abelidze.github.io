...
var anim_monsterIdle = new Animation(img_enemyIdle, 8, 0, 0, 48, 48, 12);
var anim_monsterMove = new Animation(img_enemyMove, 8, 0, 0, 48, 48, 2);

/* Init sprites */
var spr_player = new Sprite([anim_playerIdle, anim_playerMove]);
var spr_enemy = new Sprite([anim_enemyIdle, anim_enemyMove]);
var spr_monster = new Sprite([anim_monsterIdle, anim_monsterMove]);